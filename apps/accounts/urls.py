...
urlpatterns = [
    ...
    path('alterar-perfil/<int:id_user>/', views.change_user_profile, name='change_user_profile'),
    path('alterar-info-usuario/<username>/', views.change_user_info, name='change_user_info'),
]
