...
def add_category(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Ocorreu um erro. A categoria não foi adicionada.')            
...
def edit_category(request, id_category):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('task:list_categories')
        else:
            messages.error(request, 'Ocorreu um erro. A categoria não foi editada.')
...
def add_task(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Ocorreu um erro. A tarefa não foi adicionada.')
...
def edit_task(request, id_task):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Ocorreu um erro. A tarefa não foi editada.')
